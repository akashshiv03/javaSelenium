...
//		
//	      driver.findElement(By.xpath("//input[@id='autocomplete']")).sendKeys("akash789546");
...
//	      driver.findElement(By.xpath("//input[@value='option1']")).click();
		...
		driver.findElement(By.xpath("//button[contains(@id,'u_0_10')]"));
